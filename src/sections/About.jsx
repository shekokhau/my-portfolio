          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
              <p>
                ...
                web applications that solve real-world problems. My interest in
                how the web works has grown into practical expertise in modern
              ...
              <p>
                ...
                experiment with personal projects, and continually refine my
                development skills.
              </p>
            </div>
            ...
            <div className="glass rounded-2xl p-6 glow-border animate-fade-in animation-delay-300">
              <p className="text-lg font-medium italic text-foreground">
                "My mission is to create digital experiences that are both
                functional and enjoyable to use — products that users love to
